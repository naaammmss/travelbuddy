...
<html lang="en"> 
    <head> 
        ...
        <title>Admin Registration | Secure Access</title> 
    ...
    <body class="flex items-center justify-center min-h-screen relative"> 
        ...
        <div class="flex flex-col md:flex-row w-[90%] max-w-5xl rounded-3xl overflow-hidden shadow-2xl glass z-10">
            ...
            <div class="hidden md:flex flex-col justify-center items-center text-white p-10 w-1/2 bg-gradient-to-br from-blue-800 via-indigo-700 to-purple-700">
                <i class="fas fa-user-shield text-6xl mb-6 floating"></i>
                <h1 class="text-3xl font-bold mb-3">
                    Admin Portal Access
                </h1>
                <p class="text-blue-100 text-center leading-relaxed">
                    Create your secure administrator account to manage system operations.
                </p>
                <a href="{{ route('admin_login') }}" 
                    ...
                    <i class="fas fa-right-to-bracket mr-2"></i>Go to Login
                </a>
            </div>
            ...
            <form action="{{ route('admin_register') }}" 
                method="POST" 
                class="space-y-6" 
            ...
            <p class="text-center text-gray-600 mt-8">
                ...
                <a href="{{ route('admin_login') }}" class="text-blue-600 font-semibold hover:underline">Sign In</a>
            </p>
            </div>
